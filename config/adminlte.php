...
return [
    ...
    */
    ...
    'logo' => '<b>Ad</b>mira',
    'logo_img' => 'vendor/adminlte/dist/img/AdmiraBlancoRedondo.png',
 ...
 /*
    ...
    */
    ...
    [
        ...
        [
            'text' => 'Margen y utilidad',
            'route' => 'reportes.margen',
        ],

        [
            'text' => 'Productos más rentables',
            'route' => 'reportes.rentables',
        ],

        [
            'text' => 'Productos más vendidos',
            'route' => 'reportes.mas_vendidos',
        ],

        [
            'text' => 'Tendencia de ventas',
            'route' => 'reportes.tendencia',
        ],

        [
            'text' => 'Ventas por hora (horas pico)',
        ...
        [
            ...
            'route' => 'reportes.ticket',
        ],

        [
            'text' => 'Productos sin rotación',
            'route' => 'reportes.sin_rotacion',
        ],

        [
            'text' => 'Stock crítico',
            'route' => 'reportes.stock_critico',
        ],
        ...
        'custom_css' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/adminlte/dist/css/admira.css',
                ],
            ],
        ],
    ],
